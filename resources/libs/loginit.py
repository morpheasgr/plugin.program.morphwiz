...
ORDER = ['easynews-fen',
         'fanart-exodusredux', 'fanart-filmnet', 'fanart-gaia', 'fanart-numbers',
         'fanart-metadatautils', 'fanart-premiumizer', 'fanart-realizer',
         'fanart-scrubs', 'fanart-seren', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         'imdb-exodusredux', 'imdb-filmnet', 'imdb-gaia', 'imdb-numbers', 'imdb-premiumizer',
         ...
         'login-eis', 'tmdb-gaia',
         'tmdb-exodusredux', 'tmdb-filmnet', 'tmdb-fen', 'tmdb-metadatautils', 'tmdb-numbers',
...
LOGINID = {
    ...
    'login-opensubsbyopensubs': {
        ...
        'activate' : ''},
    'fanart-filmnet': {
        'name'     : 'Fanart.tv - Filmnet',
        'plugin'   : 'plugin.video.filmnet',
        'saved'    : 'fanart-filmnet',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'filmnet_fanart'),
    ...
    'tmdb-filmnet': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'filmnet_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.filmnet', 'settings.xml'),
        'default'  : 'tm.user',
        'data'     : ['tm.user'],
        'activate' : ''},
    'imdb-filmnet': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.filmnet', 'fanart.jpg'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'filmnet_imdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.filmnet', 'settings.xml'),
        'default'  : 'imdb.user',
        'data'     : ['imdb.user'],
        'activate' : ''},

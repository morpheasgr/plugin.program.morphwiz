...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR blue][B]Morph[/B][/COLOR]Wiz'
BUILDERNAME = 'Morpheas'
EXCLUDES = ['plugin.program.morphwiz', 'repository.morpheas']
# Text File with build info in it.
BUILDFILE = 'http://bit.ly/mrphwz'
...
THEME1 = '[COLOR '+COLOR1+'][I]([COLOR '+COLOR1+'][B]Morph[/B][/COLOR][COLOR ' + COLOR2 + ']Wiz[COLOR ' + COLOR1 + '])[/I][/COLOR] [COLOR '+COLOR2+']{0}[/COLOR]'
...
HIDECONTACT = 'Yes'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing MorphWiz.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR blue][B]Morph[/B][/COLOR]Wiz'
